...
dfs=sets_loaded['sample361.pickle']
...
def cor_frc_finexp(adhesion, E, L_c, L_m, N_att):
    ...
    cor_frc['log2lambda']=cor_frc['log2lambda_raw'].loc[cor_frc.index[ cor_frc['log2lambda_raw']>-6.4  ]]
    cor_frc['log2sigma']=cor_frc['log2sigma_raw'].loc[cor_frc.index[ cor_frc['log2lambda_raw']>-6.4  ]]
...
ax.set_title('N$_\\mathrm{total}$=361')
ax.set_xlim((-6.4,-5.3))
ax.set_ylim((-3,2))
...
ax3.set_title('N$_\\mathrm{total}$=361')
# legend generation
...
fig.tight_layout()
fig.savefig("S361_log2sigma.pdf")
fig2.tight_layout()
fig2.savefig("S361_sigma_deexp.pdf")
