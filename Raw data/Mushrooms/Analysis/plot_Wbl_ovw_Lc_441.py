...
def cor_frc_finexp(adhesion, E, L_c, L_m, N_att):
    ...
    cor_frc['log2lambda']=cor_frc['log2lambda_raw'].loc[cor_frc.index[ cor_frc['log2lambda_raw']>-10.8  ]]
    cor_frc['log2sigma']=cor_frc['log2sigma_raw'].loc[cor_frc.index[ cor_frc['log2lambda_raw']>-10.8  ]]
...
for preload in cor_frc:
    ...
    [ax.plot( cor_frc[preload][ret]['log2lambda'], cor_frc[preload][ret]['log2sigma'], 
        marker='o', ms=0, lw=1, mew=0.4, markevery=3, mfc='None', **preload_axs[preload]['plotargs']  ) 
        for ret in cor_frc[preload]]
    [ax2.plot( adhesion[preload][ret]['lambda'], cor_frc[preload][ret]['sigma_deexp']*cor_frc[preload][ret]['lambda'], 
...
fig.tight_layout()
fig.savefig("S441_log2sigma.pdf")
fig2.tight_layout()
fig2.savefig("S441_sigma_deexp.pdf")
