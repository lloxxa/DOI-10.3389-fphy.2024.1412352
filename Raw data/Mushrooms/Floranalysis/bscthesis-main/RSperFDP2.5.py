# -*- coding: utf-8 -*-
"""
Created on Thu Oct 13 09:44:11 2022
...
pad='C:\\Users\\Helmendach\\Documents\\Wageningen Moleculair\\3e jaar\\Thesis@PCC\\Data\\Representatieve curves\\Retraction speed\\P2.5\\'
lijst=glob.glob(r"C:\Users\Helmendach\Documents\Wageningen Moleculair\3e jaar\Thesis@PCC\Data\Representatieve curves\Retraction speed\P2.5\*")
...
Ptwee={pad+'Eco_P2_5_FN4_v_retrSpd10_onespeed_Interval_7.csv':{'grens':9.25},
       pad+'Eco_P2_5_FN4_v_retrSpd30_onespeed_Interval_7.csv':{'grens':10},
       pad+'Eco_P2_5_FN4_v_retrSpd50_onespeed_Interval_7.csv':{'grens':10},
       pad+'Eco_P2_5_FN4_v_retrSpd100_onespeed_Interval_7.csv':{'grens':10.2},
       pad+'Eco_P2_5_FN4_v_retrSpd200_onespeed_Interval_7.csv':{'grens':10.1},
       pad+'Eco_P2_5_FN4_v_retrSpd300_onespeed_Interval_7.csv':{'grens':10},
       pad+'Eco_P2_5_FN4_v_retrSpd500_onespeed_Interval_7.csv':{'grens':10},
       pad+'Eco_P2_5_FN4_v_retrSpd1000_onespeed_Interval_7.csv':{'grens':9.7},
       pad+'Eco_P2_5_FN4_v_retrSpd1500_onespeed_Interval_7.csv':{'grens':9.7},
       pad+'Eco_P2_5_FN4_v_retrSpd2000_onespeed_Interval_7.csv':{'grens':9.6},
       pad+'Eco_P2_5_FN4_v_retrSpd2500_onespeed_Interval_7.csv':{'grens':9.7},
       pad+'Eco_P2_5_FN4_v_retrSpd3000_onespeed_Interval_7.csv':{'grens':9.7}
       }
...
plotargs={pad+'Eco_P2_5_FN4_v_retrSpd10_onespeed_Interval_7.csv':{'c' : cmap(0.01),'label':' 1.1 N',  'marker':'o', 'mfc':'w', 'mec':'k', 'markersize':8},
       ...
       pad+'Eco_P2_5_FN4_v_retrSpd200_onespeed_Interval_7.csv':{'c' : cmap(0.3),'label':' 1.1 N',  'marker':'^', 'mfc':'w', 'mec':'k', 'markersize':8},
       ...
       pad+'Eco_P2_5_FN4_v_retrSpd3000_onespeed_Interval_7.csv':{'c' : cmap(0.99),'label':' 1.1 N', 'marker':'s', 'mfc':'w', 'mec':'k', 'markersize':8}
       }
...
[ax.scatter(metstrain[naam]['strain'], metstrain[naam]['stress'], s=0.7, **plotargs2[naam]) for naam in metstrain if (float(naam.split('_')[5][7:])==10)|(float(naam.split('_')[5][7:])==200)|(float(naam.split('_')[5][7:])==3000)]
[ax.plot(rang, theoretisch[naam], markevery=10, **plotargs[naam]) for naam in theoretisch if (float(naam.split('_')[5][7:])==10)|(float(naam.split('_')[5][7:])==200)|(float(naam.split('_')[5][7:])==3000)]
#maakt colorbar
...
ax.legend(legend_lines, [10, 200, 3000])
pp.show()