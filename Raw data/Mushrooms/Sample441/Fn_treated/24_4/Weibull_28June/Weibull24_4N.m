...
annotation(gcf,'textbox',[0.2 0.7 0.3 0.08],...
    'String',{['m = ',num2str(round(slop_m,2)) '\pm',num2str(round(err_slop_m,4))], ['\sigma_o = ',num2str(round(sigma_m,2)), '\pm',num2str(round(err_sigma_m,3)) 'N']},...
    'FitBoxToText','off');
%liner fit of all vectors
  ...
  annotation(gcf,'textbox',[0.2 0.6 0.28 0.25],...
    'String',{['Lm = ',num2str(round(Lm,4))],['m1 = ',num2str(round(slop1,3)), ', \sigma_1 = ',num2str(round(sigma01,3))], ['m2 = ',num2str(round(slop2,3)), ', \sigma_2 = ',num2str(round(sigma02,3))],.....
    ['m3 = ',num2str(round(slop3,3)),', \sigma_3 = ',num2str(round(sigma03,3))], ['m4 = ',num2str(round(slop4,3)),', \sigma_4 = ',num2str(round(sigma04,3))], ['m5 = ',num2str(round(slop5,3)),', \sigma_5 = ',num2str(round(sigma05,3))]});
hold off 
