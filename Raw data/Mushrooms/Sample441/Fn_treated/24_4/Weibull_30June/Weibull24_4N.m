...
x2 = x(a+10:2*a-4);x2=x2-x2(1); 
y2 = y(a+10:2*a-4); y2=y2-y2(1); 
plot(x2,y2)

x3 = x(2*a+10:3*a-4); x3=x3-x3(1); 
y3 = y(2*a+10:3*a-4); y3=y3-y3(1); 
plot(x3,y3)

x4 = x(3*a+10:4*a+30);x4=x4-x4(1); 
y4 = y(3*a+10:4*a+30);y4=y4-y4(1); 
plot(x4,y4)

x5 = x(4*a+42:5*a+2); x5=x5-x5(1); 
y5 = y(4*a+42:5*a+2); y5=y5-y5(1); 
plot(x5,y5)
%%
...
slop1 = (Pn1(1));
intercept1 = (Pn1(2));
sigma01=exp(-intercept1/slop1); % in N
...
sigma = [sigma01 sigma02 sigma03 sigma04 sigma05]*1000; % in mN
