...
%%
Lc = 11.1e-3; 
S1= -y1./A1; %% force obtained from the experimental curve in N 
S2= -y2./A2;
S3= -y3./A3;
S4= -y4./A4;
S5= -y5./A5;
...
%%
E1 = Eo1;   %% We are examining forces no stress
E2 = Eo2;
E3 = Eo3;
E4 = Eo4;
E5 = Eo5;
...
annotation(gcf,'textbox',[0.2 0.7 0.3 0.08],...
    'String',{['m = ',num2str(round(slop,2))], ['\sigma_o = ',num2str(round(sigma0,2)), 'Pa']},...
    'FitBoxToText','off');

  figure(8)
  hold on
  ff= E1*D1.*exp(-(E1*D1/sigma0).^slop).*(1-exp(-D1/W));  
  plot(E1*D1,ff)
