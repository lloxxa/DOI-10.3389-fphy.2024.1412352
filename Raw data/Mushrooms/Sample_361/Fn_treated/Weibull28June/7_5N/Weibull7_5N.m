...
saveas(figure1, "Force_distance.png")
...
xlabel("d/L_c (-)");
ylabel("-F/(nA_0) (mPa)")
plot(D11,Yfit1,'-k', D22, Yfit2, '-k', D33, Yfit3, '-k', D44, Yfit4, '-k', D55, Yfit5, '-k');  
...
annotation(gcf,'textbox',[0.2 0.7 0.3 0.18],...
    'String',{['Eo1 = ',num2str(round(Eo1,3)),' Pa'], ['Eo2 = ',num2str(round(Eo2,3)),' Pa'], ['Eo3 = ',num2str(round(Eo3,3)),' Pa'],['Eo4 = ',num2str(round(Eo4,3)),' Pa'], ['Eo5 = ',num2str(round(Eo5,3)),' Pa']}, 'LineStyle', 'none');
saveas(stress_strain, "stress_strain.png");
...
hold off 
saveas(figfit, "figfit.png");


%% manually fitted constants
figure(8)
sigma01=0.3;
slop1= 0.4 ;
  hold on
